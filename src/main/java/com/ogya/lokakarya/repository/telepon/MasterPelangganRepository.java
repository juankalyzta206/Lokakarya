...
public interface MasterPelangganRepository extends JpaRepository<MasterPelanggan, Long> {
	...
	// List<MasterPelanggan>
	// findByidPelangganOrNamaIgnoreCaseContainingOrAlamatIgnoreCaseContainingOrNoTelpOrUsers(Long
	// idPelanggan,String nama,String alamat,Long noTelp,Users user);
	Page<MasterPelanggan> findByidPelangganOrNamaIgnoreCaseContainingOrAlamatIgnoreCaseContainingOrNoTelpOrUsers(
			Pageable page, Long idPelanggan, String nama, String alamat, Long noTelp, Users user);
